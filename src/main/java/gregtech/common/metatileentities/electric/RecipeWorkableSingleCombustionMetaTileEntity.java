...
/**
 * As {@code MetaTileEntitySingleCombustion} (legacy), but backed by {@link RecipeWorkableGeneratorMetaTileEntity}.
 */
public class RecipeWorkableSingleCombustionMetaTileEntity extends RecipeWorkableGeneratorMetaTileEntity {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new RecipeWorkableSingleCombustionMetaTileEntity(metaTileEntityId, recipeMap, renderer, getTier(),
